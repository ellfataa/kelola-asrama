                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('rooms.update', $room) }}" method="POST">
                        ...
                        @method('PUT') <div class="mb-4">
                            ...
                            <input type="text" name="number" value="{{ old('number', $room->number) }}" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full mt-1" required>
