<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                <x-input-label for="password_confirmation" :value="__('Konfirmasi Password')" class="text-slate-700 font-semibold text-xs uppercase tracking-wide mb-1" />
        ...
        <div class="text-xs text-slate-500 text-center px-4">
            Dengan mendaftar, Anda menyetujui <span class="underline text-indigo-600">Syarat & Ketentuan</span> kami.
        </div>
        ...
        <div class="text-center mt-4 pb-2">
            <p class="text-sm text-slate-600">
                Sudah memiliki akun?
                <a href="{{ route('login') }}" class="font-bold text-indigo-600 hover:text-indigo-800 hover:underline transition">
                    Masuk Sekarang
                </a>
            </p>
        </div>
